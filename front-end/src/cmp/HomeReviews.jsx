...
export function HomeReviews() {
    ...
    { txt: "We used Dimerr for SEO, our logo, website, copy, animated videos — literally everything. It was like working with a human right next to you versus being across the world.", writers: "Lucy, Co-Founder ", company: "Goggle", imgUrl: 3 },
    ]

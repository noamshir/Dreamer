...
async function saveReview(rate, txt, user, owner) {
  ...
  socketService.emit(SOCKET_EMIT_ADD_REVIEW,review);
  ...
  return [
    {
      ...
      sellerInfo: {
        ...
        origin: "Israel",
        languages: ["en", "he"],
        skills: ["logo-design", "programming"],
        sellerDesc:
          userDescs[utilService.getRandomIntInclusive(0, userDescs.length - 1)],
      },
    ...
    },
    {
      ...
      sellerInfo: {
        ...
        sellerDesc:
          "Hey, Thank you for visiting my profile, I help entrepreneurs, startups, enterprises, and every business to design Creative logo designs to bring their ideas into reality, I offer the highest quality in service, customer support. You can check my profile for previous designs.",
      },
    ...
    },
    {
      ...
      sellerInfo: {
        ...
        skills: ["logo-design", "illustration"],
        sellerDesc:
          "We are a team of professionals who do almost everything you may require for your media based companies. We are your one-stop destination for Graphics Design services, Web Design & Development services and Digital Marketing services. If you have any questions, we are just one message away.",
      },
    ...
    },
    {
      ...
      sellerInfo: {
        ...
        skills: ["logo-design", "illustration"],
        sellerDesc:
          "Hey there!I am the designer behind Zakdesignz and my nickname is Zak.I have been working as a professional graphic and brand designer since 2012. I love to work creatively and logically with quality design and customer satisfaction being my number one priority.",
      },
    ...
    },
    {
      ...
      sellerInfo: {
        ...
        sellerDesc:
          "I was born and raised in the Midwest & have been working with computers since the early 90's. My specialties include programming with the Amazon Marketing API, python, SQL and scraping information from websites.",
      },
    ...
    },
    {
      ...
      sellerInfo: {
        ...
        skills: ["programming", "wordpress"],
        sellerDesc:
          "I am a professional software and web developer. I am a certified python expert with professional work experience. If you have any type of work in web development or python then you are in the right place. I assure you of my best services. Contact me to discuss about the problem and I will provide you the best solution. Thanks :-)",
      },
    ...
    },
    {
      ...
      sellerInfo: {
        ...
        skills: ["video", "music"],
        sellerDesc:
          "I have never considered making business commercials for brands as my job. It is my passion to help a business get discovered and gain recognition through my high-end editing talent. I love finding creative solutions in how to get the best result of the raw footage.",
      },
    ...
    },
    {
      ...
      sellerInfo: {
        ...
        skills: ["voice over", "music"],
        sellerDesc:
          "I am a creative. From acting in TV, Theater, and Film, to Music production, voice overs, songs and script writing. These are what I spend the majority of my time doing. I take pride in the my work and therefor give my 100% with whatever project I commit to.",
      },
    ...
    },
    {
      ...
      sellerInfo: {
        ...
        skills: ["illustration", "logo design"],
        sellerDesc:
          "Hi everyone ♥ I have a degree in illustration, my skills range from classic watercolor illustration to digital illustrations! I work with photoshop and make projects of all kinds, from children's illustrations to hand drawn logo for entrepreneurs. You can consult me about any project that interests you and the prices vary according to the complexity of the illustrations. I look forward to working with you! ♥",
      },
    ...
    },
    {
      ...
      sellerInfo: {
        ...
        skills: ["illustration", "logo design"],
        sellerDesc:
          "An illustrator based in Zurich. My main areas of interest are book and editorial illustration, advertising, traveling and lifestyle.",
      },
